...
Invoke a library API function from the command-line:
    ...
    $ clojure -X clj-playground.core/foo :a 1 :b '"two"'
...
Your library will be deployed to net.clojars.clj-playground/clj-playground.core on clojars.org by default.
...
Copyright © 2021 Aleksandersumowski
